...
assert 10 'int main() { return - - +10; }'
assert 7 'int main() { return -(1+2)+10; }'
...
assert 1 'int main() { return sub2(5, 4); } int sub2(int x, int y) { return x - y; }'
...
assert 0 'int main() { int x[2][3]; int *y = x; *y = 0; return **x; }' # *y = x; -> x[0] (int (*)[3])
assert 1 'int main() { int x[2][3]; int *y = x; *(y+1) = 1; return *(*x+1); }' # *x -> x[0], *x+1 -> x[0][1]
assert 2 'int main() { int x[2][3]; int *y = x; *(y+2) = 2; return *(*x+2); }'
assert 3 'int main() { int x[2][3]; int *y = x; *(y+3) = 3; return **(x+1); }' # *(x+1) x[1]
...
assert 5 'int main() { int x[3]; x[0] = 3; x[1] = 4; 2[x] = 5; return *(x+2); }'
